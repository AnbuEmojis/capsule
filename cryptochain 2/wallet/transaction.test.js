...
const { REWARD_INPUT, MINING_REWARD, TOKEN_REWARDS } = require('../config');
...
describe('Transaction', () => {
    ...
    describe('outputMap', () => {
        ...
        it('outputs the amout to the recipient', () => {
    ...
    describe('rewardTransaction()', () => {
        ...
        it('creates one transaction for the miner with the `MINING_REWARD`', () => {
            expect(rewardTransaction.outputMap[minerWallet.publicKey]).toEqual(TOKEN_REWARDS);
        })
    });
});